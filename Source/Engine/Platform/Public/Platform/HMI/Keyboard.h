...
namespace Platform
{
    ...
    public:
        ...
        PLATFORM_EXPORT CharCallbackType& OnCharEvent() { return m_CharCallback; }

    private:
        // Only the WindowImpl is allowed to create a Keyboard
        friend class WindowImpl;

        // Sets up keyboard binding for the window.
        ...
        static void GLFWkeyfunStatic(GLFWwindow* window, int key, int scancode, int action, int mods);
